...
echo "=== 03-apps-y-tlp.sh: TLP + códecs + apps curadas + apps finales ==="

# --- TLP (gestión de energía) — quitar tuned/tuned-ppd primero, chocan ---
...
# --- Apps curadas (GTK4/libadwaita, coherentes con el tema) ---
sudo dnf install -y \
  loupe \
  mpv celluloid \
  decibels \
...
echo "=== 03-apps-y-tlp.sh completado ==="
